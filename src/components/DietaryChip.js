...
// Selectable chip for the Profile page's dietary-restrictions section. Kept
// as a distinct component from AllergenChip (separate concern per the
// redesign spec) even though the visual treatment is intentionally
// consistent.
export default function DietaryChip({ label, icon: Icon, selected, onToggle }) {
  return (
    <button
      type="button"
      role="checkbox"
